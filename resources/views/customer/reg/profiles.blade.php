        ...
        <div class="row mx-auto">
            <div class="col-md-6">
                <form action="{{ url('/chating') }}" method="post">
                    @csrf
                    <textarea name="chating" rows="20" class="form-control"></textarea>
                </form>
            </div>
            <div class="col-md-6">
                            ...
                            <div class="card-body">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td >
                                            <label>Name</label>
                                            <input type="text"  name="name" value="{{ $profile->customer_name->name }}" class="form-control name" placeholder="Enter Name....">
