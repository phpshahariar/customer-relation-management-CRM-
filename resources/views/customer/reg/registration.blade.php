                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-12 tab-content" >
                                ...
                                <textarea class="form-control " rows="16" readonly name="chating" id="chatHistory"></textarea>
        {{--                        @foreach($show_history as $history)--}}
        {{--                            <p>{!! $history->chating !!}<br/>{!! $history->created_at !!}<br/>{!! Auth::user()->name !!}</p>--}}
        {{--                        @endforeach--}}
                            </div>
                            <br/>
                            <br/>
...
{{--                                            </li>--}}
                                            <li class="nav-item active">
                                                <a class="btn btn-info" data-toggle="modal" data-target="#smsModal" href="#">SMS</a>
                                            </li>
